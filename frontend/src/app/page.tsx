      ...
      <div className="flex w-full gap-6">
        ...
        <div className="flex-1 min-w-0">
          <div className="space-y-4 w-full">
            {/* Stories */}
            <div className="glass-modern p-4 overflow-x-auto scrollbar-hide w-full">
            ...
            {/* Create Post Bar */}
            {isAuthenticated && (
              <div className="glass-modern p-4 flex items-center gap-3 w-full">
            ...
            {/* Tabs */}
            <div className="tab-nav-facebook w-full">
              {[
...
function VideoCard({
  ...
  return (
    <div className="video-card-youtube w-full">
...
function PostCard({
  ...
  return (
    <div className="post-card-facebook w-full">
